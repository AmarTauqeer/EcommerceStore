...
const ProductCard: React.FC<propsTypes> = ({ img, title, description, price, productId, userId, token, quantity, amountPerProduct, cartId, cartCount }) => {
  const apiUrl = process.env.NEXT_PUBLIC_API_URL;
  
  const [imageSource, setImageSource] = useState(`${apiUrl}Uploads/` + img);
